...
<input type="text" class="form-control" name="admission_year" id="admission_year" value="<?php echo $rows->admisn_year; ?>" readonly>
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                              ...
                                              <!--select name="sex" disabled class="selectpicker form-control" data-style="btn-default btn-block" >
								 ...
								 <label class="checkbox checkbox-inline">
									...
									<label class="checkbox checkbox-inline">
									 ...
									 <label class="col-sm-2 control-label">Language Proposed</label>
                                      <div class="col-sm-4">
                    <select name="lang" class="selectpicker" disabled  data-style="btn-default btn-block" >
							      ...
							      <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="row">
												<div class="col-md-4">
                                  <input type="text" name="sch_name" readonly value="<?php echo $rows->last_sch_name; ?>" class="form-control">
                                                 </div>
                                                    <div class="col-md-4">
				<select name="class_name" class="selectpicker" disabled >
				...
				<script language="JavaScript">document.formadmission.class_name.value="<?php echo $rows->last_studied; ?>";</script>
                    ...
                    <div class="col-md-4">
						<select name="qual" class="selectpicker" disabled >
