                              ...
                              <tbody>
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td class="text-left">
                                        <a href="<?php echo base_url(); ?>fees_structure/edit_fees_master_status/<?php echo $rows->id; ?>" rel="tooltip" title="Edit" class="btn btn-simple btn-warning btn-icon edit"><i class="fa fa-edit"></i></a>
                                    </td>
                                  </tr>
                                  <?php $i++;  }  ?>
                              </tbody>
