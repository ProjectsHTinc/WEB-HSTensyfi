...
<div class="col-md-12">
                     ...
                     <?php endif;
                            ...
                            <div class="content">
                                <form method="post" action="<?php echo base_url(); ?>fees_structure/update_fees_master" class="form-horizontal" enctype="multipart/form-data" id="feesform" name="feesform">
