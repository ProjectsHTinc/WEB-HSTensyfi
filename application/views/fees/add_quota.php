           ...
           <div class="row">
               <div class="col-md-8">
                   <div class="card">
                       ...
                       <div class="content">
                           <form method="post" action="<?php echo base_url(); ?>fees_structure/create_quota" class="form-horizontal" enctype="multipart/form-data" id="feesformsection" name="feesformsection">
                                 <fieldset>
                              ...
                              <tbody>
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td class="text-right">
                                      <a href="<?php echo base_url(); ?>fees_structure/edit_quota/<?php echo $rows->id; ?>" class="btn btn-simple btn-warning btn-icon edit"><i class="fa fa-edit"></i></a>
                                    </td>
                                  </tr>
							                  <?php $i++;   } ?>
                              </tbody>
