           ...
           <div class="row">
               <div class="col-md-8">
                   <div class="card">
                       ...
                       <div class="content">
                           <form method="post" action="<?php echo base_url(); ?>feesstructure/create_quota" class="form-horizontal" enctype="multipart/form-data" id="feesformsection" name="feesformsection">
                                 <fieldset>
