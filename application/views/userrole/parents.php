                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                              ...
                              <h4 class="title">List of Parents
							  <button style="float:right;" class="btn btn-info btn-fill center download">Export Excel</button>
							<button style="float:right;margin-right: 10px;" class="btn btn-info btn-fill center" onclick="generatefromtable()">Export PDF</button></h4>
