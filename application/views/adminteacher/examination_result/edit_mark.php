                                ...
                                <table class="table table-hover table-striped">
                                   ...
                                   <?php foreach($edit as $row)
                                    ...
                                    <tbody>
										...
										<td>
										<?php if(!empty($mark)){?>
									 <input style="width:30%;" type="text" readonly name="marks[]" value="<?php echo $row->marks; ?>" class="form-control"/>
										<?php }else{ ?>
										<input style="width:30%;" type="text"  name="marks[]" value="<?php echo $row->marks; ?>" class="form-control"/>
										<?php } ?>
										</td>	
										</tr>
									 <?php $i++;} 
