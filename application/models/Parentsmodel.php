...
//CREATE ADMISSION
       ...
       mail($to,$subject,$htmlContent,$headers);
		 ...
		 // $userFileName;
			 $query1="INSERT INTO edu_users(name,user_name,user_password,user_type,parent_id,created_date,updated_date,status) VALUES('$father_name','$user_id',md5($OTP),'4','$insert_id',NOW(),NOW(),'A')";
