    ...
    function get_teacher_onduty_details()
     {
    	 ...
    	 $query="SELECT du.*,u.user_id,u.name FROM edu_on_duty AS du,edu_users AS u WHERE du.user_type=2 AND du.user_id=u.user_id AND du.year_id='$current_year'" ; 
