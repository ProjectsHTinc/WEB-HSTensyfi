 ...
 public function __construct()
  {
    ...
    function getall_details($user_id)
	 {
		 $query="SELECT l.*,lm.id,lm.leave_title,lm.leave_type,lm.status FROM edu_user_leave AS l,edu_user_leave_master AS lm WHERE l.user_id='$user_id' AND l.leave_master_id=lm.id ORDER BY l.leave_id desc";
